# This script runs the dynamic & staic Forward Analysis and Adjoint calculations for MDO
# Must be called for each design iteration during MDO or once for MDA
...
def MDA(Nnodes, Nelems, E, nu, rho, n):
    ...
    # 1 -> Write input deck for dynamic analysis
    if (n ==1):
...
#       Temp_Dir = os.getcwd()
    ...
    # For n> 1 Temp_Dir should be available 
    ...
    # Copy the FSI-related files from root to the DSN Directory
    ...
    # Copy the Solid (.inp + .nam + .msh files) to the DSN directory
