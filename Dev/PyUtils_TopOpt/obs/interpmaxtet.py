...
if __name__ == "__main__":
    ...
    for iter in np.array([0]):
        ...
        outputfile= "rhoInterpmax"+str(iter)+".dat"

        Nodeid, X, Y, Z, Eleid, E1, E2, E3, E4, densityinterp_ave =interp_tet(mesh,rho, Nnodes, Nelems)
        file = open(outputfile, "w")
        file.write("TITLE = \"Visualization of the solid solution\"")
        file.write("\n")
        file.write("VARIABLES = \"x\"\"y\"\"z\"\"Rho\"")
        file.write("\n")
        file.write("ZONE STRANDID=2, SOLUTIONTIME="+str(iter)+", NODES="+str(Nnodes)+", ELEMENTS="+ str(Nelems)+", DATAPACKING=POINT, ZONETYPE=FETETRAHEDRON")
