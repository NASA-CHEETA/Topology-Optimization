...
def TopOpt(restartFlag):
    ...
    ccxversion="ccx_mkleqnnz"
    inp= "raeFSI_TO"
    passivefilename = False #'passiveElemList.nam'   # elements excluded from design doamin, FALSE if empty
    ...
    # Keep Heaviside projection filter off for now. Ignore following sections 
    callrunccx.beta = 0.000001  # Beta
    callrunccx.beta_factor = 2 # Beta multiplier
    callrunccx.betamax = 0.000001
    callrunccx.beta_iter = 20  # Iteration for each beta update
    callrunccx.beta_iter_init = 1
    callrunccx.eta = 0.5
