...
double Precice::initialize(){
  ...
  if (localNumberWetSurfaces < 1) {
    ...
    cout << "ERROR: Inaccurate spatial discretization of the Aero-elastic Surface!\n";
    processWorkingOnWetSurface = false;
  }

  if (processWorkingOnWetSurface) {
    cout << " Discretizing Aero-elastic Interface! \n";
...
void Precice::finalize(){
  ...
  cout << " Aero-Elastic Computation is complete! \n";
}
