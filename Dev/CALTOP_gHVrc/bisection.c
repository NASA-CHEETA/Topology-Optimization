...
void bisection(ITG **ipkonp, ITG *ne,double *designFiltered, double* dHSVector,double* beta_H,double* eta_H){
...
/*FILE *rhoFile;
    ...
    FORTRAN(heaviside,(ne1,&nea, &neb, designFiltered1, dHSVector1, beta_H1, eta_H1));
