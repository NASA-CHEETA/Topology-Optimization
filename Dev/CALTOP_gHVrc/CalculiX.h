...
void FORTRAN(heaviside,(ITG *ne,ITG *nea,ITG *neb,double *designFiltered,double *designFilteredH, double *dHSVector,
						double *beta_H, double* eta_H));

void FORTRAN(dheaviside,(ITG *ne,ITG *nea,ITG *neb,double *designFiltered,double *designFiltered2, double *dHSVector));
