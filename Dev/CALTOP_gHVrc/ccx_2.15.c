...
if(argc==1){printf("Usage: Flags: -i jobname -p PENALTY -q HIGHERORDERFILTER -r RADIUS -v VOLUMEFRACTION -s ITERATION -f FILTERNNZ -e eta -b beta \n");FORTRAN(stop,());}
else{
  for(i=1;i<argc;i++){
...
SFREE(gradComplFiltered2);SFREE(eleVolFiltered2);
SFREE(dHSVector);
