...
static double *designFiltered1,*designFilteredH1,*dHSVector1, *beta_H1, *eta_H1;

void heavisidefilter(ITG **ipkonp, ITG *ne,double *designFiltered, double *designFilteredH, double* dHSVector,double* beta_H,double* eta_H){
...
// num_cpus=1;// overwrite for now to 1 CPU only
    ...
    designFilteredH1=designFilteredH;
    dHSVector1 = dHSVector;
    beta_H1 = beta_H;
    eta_H1 = eta_H;
  
    printf(" Using up to %" ITGFORMAT " cpu(s) for the Projection Vector.\n\n", num_cpus);
	...
	ithread[i]=i;
	pthread_create(&tid[i], NULL, (void *)heavisidefiltermt, (void *)&ithread[i]);
    }
...
/*FILE *rhoFile;
    ...
    FORTRAN(heaviside,(ne1,&nea, &neb, designFiltered1, designFilteredH1, dHSVector1, beta_H1, eta_H1));
