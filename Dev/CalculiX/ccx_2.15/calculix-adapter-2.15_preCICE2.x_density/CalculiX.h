...
void rho(double *design,int ne, double p);
...
void arpackbu(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	     ...
	     double *prop,char *orname,char *typeboun, double *design, double *penal);
...
void mafillsmmain(double *co,ITG *nk,ITG *kon,ITG *ipkon,char *lakon,
	       ...
	       ITG *network,ITG *ntrans,ITG *inotr,double *trab, double *design, double *penal);
...
void nonlingeo_precice(double **cop, ITG *nk, ITG **konp, ITG **ipkonp, char **lakonp,
         ...
         char *preciceParticipantName, char *configFilename, double *design, double *penal);
