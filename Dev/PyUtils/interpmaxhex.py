...
def interp_hex(mesh,inputrhofile, Nnodes, Nelems):
    ...
    return Nodeid, X, Y, Z, Eleid, E1, E2, E3, E4, E5, E6, E7, E8, densityinterp_ave
...
if __name__ == "__main__":
    ...
    Nodeid, X, Y, Z, Eleid, E1, E2, E3, E4, E5, E6, E7, E8, densityinterp_ave= interp_hex(mesh,inputrhofile, Nnodes, Nelems)
