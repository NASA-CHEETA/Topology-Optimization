...
def write2tecio(mesh, passivefilename, Nnodes, Nelems, elementType, iterList, beta = 1000):
    ...
    Note: Element Types: 38= C3D8, 34=C3D4
...
if __name__ == "__main__":
    ...
    mesh = "mesh.nam"
    passivefilename =[0] #['skinElementList.nam', 'sparElementList.nam'] #'passiveElemList.nam'   # elements excluded from design doamin, put a randon integer if empty
    Nnodes= 92064
    Nelems= 470755
    elementType = 34 # 38= C3D8, 34=C3D4, 54=S4, 53=S3
